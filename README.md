...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/qt-3d-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/qt-3d-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
It is possible to list all of the versions of `qt6-3d` available on your platform:
...
```
pixi search qt6-3d --channel conda-forge
```
